...
public class HeidigiService {
	...
	public String downloadImage(String image) throws IOException {
		...
		String htmlData = "<html><body style=\" margin: 0; padding-left:2px\">"
				...
				+ " <img src=\""+logo+"\" style=' position: absolute;    top: 2%;    left: 2%;max-height: 50px;border: 1px solid  #bbb;'></img> </div> <div style='background-color:grey;width:300px;'> asdfasdf</div></body></html>"
				+ "";
